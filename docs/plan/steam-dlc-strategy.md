...
**核心模式**：BitCat 本体免费上架 Steam，通过 DLC 捆绑包提供增值内容。
...
| 模块 | 免费版内容 | 原因 |
|------|-----------|------|
| **宠物外观** | `piggy` + `cat`（2 个） | 一个默认终端风 + 一个经典伙伴形象，足够体验核心 |
...
| Wallpaper Engine | $3.99 | BitCat 是桌面 AI 伙伴，不是壁纸，但定价可参考 |
| Desktop Duck | 免费 | 简单桌面宠物，BitCat 复杂度高很多 |
